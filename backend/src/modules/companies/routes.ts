...
import { requirePermission, requirePermissionOrOwnCompany } from '../../middlewares/rbac.middleware';
...
router.get(
  '/:id',
  authenticate,
  requirePermissionOrOwnCompany(Permission.VIEW_COMPANIES),
...
router.patch(
  '/:id',
  authenticate,
  requirePermissionOrOwnCompany(Permission.MANAGE_COMPANIES),
